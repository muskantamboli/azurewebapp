...
connection_string = textwrap.dedent('''Driver={ODBC Driver 13 for SQL Server};Server=tcp:newserver789.database.windows.net,1433;Database=sprint;Uid=adminuser;Pwd=Azure@2022;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;''')
